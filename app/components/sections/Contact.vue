    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div class="space-y-6">
            ...
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-gray-600">beto@example.com</p>
              </div>
            </div>
            ...
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-gray-600">México</p>
              </div>
            </div>
          </div>
          ...
          <!-- Redes sociales -->
          <div class="mt-8">
            <h4 class="text-lg font-medium text-gray-900 mb-4">Sígueme en</h4>
...
const submitForm = async () => {
  ...
  // Mostrar mensaje de éxito (podrías usar una librería de toast)
